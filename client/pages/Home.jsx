...
const Home = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      price: 59.99,
      thumbnail:
        "https://images.unsplash.com/photo-1537432376769-00f5c2f4c892?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-xl text-zinc-300 max-w-2xl">
              Join over 500,000 students learning with Mentora. Gain in-demand
              skills from industry experts and advance your career.
            </p>
            <div className="mt-10">
              <Link
                to="/courses"
