...
const Courses = () => {
  ...
  const isTeacher = () => {
    return isAuthenticated && user && user.role === 'teacher';
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
        ...
        {/* Show Add Course button only for authenticated teachers */}
        {isTeacher() && (
          <Link
            to="/add-course"
          ...
          {filteredCourses.map((course) => (
            <CourseCard
              ...
              course={{
                ...
                instructor: course.teacher_name || "Unknown Instructor", // You might need to join with user table
                rating: 4.5, // Mock rating - you'd need to calculate this
                students: 1200, // Mock student count - you'd need to count enrollments
